...
final class SyliusPdfExtensionGotenbergTest extends AbstractExtensionTestCase
{
    ...
    public function it_creates_composite_options_processor(): void
    {
        ...
        $this->assertContainerBuilderHasService(
            'sylius_pdf.options_processor.composite.gotenberg',
